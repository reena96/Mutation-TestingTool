...
public class TracePrint implements Runnable{
    ...
    public TracePrint(String sequence, String pattern, int i) {
    ...
    private void printToFile(File file, Method methodCall, StringMatchSample_1.ViolentStringMatcher currentClass, String sequence, String pattern) throws IOException, InvocationTargetException, IllegalAccessException {
